...
NAMED_GRAPH=https%3A%2F%2Fd-nb.info%2Fgnd%2Fbibliographicdata%2Fgraph
# ================================================================
...
echo "Start script updateGndBibiliographic.sh."
# ========================
...
echo "Script updateGndBibiliographic.sh finished."
